...
summary_file_name = f'profit/profit_Dec.csv'
...
for index in range(1, 21):
    ...
    if(index < 11):
        from_date = "2023-11-" + str(20+index) + "T15:30:00.000Z"
    else:
        if(index < 20):
            from_date = "2023-12-0" + str(index-10) + "T15:30:00.000Z"
        else:
            from_date = "2023-12-" + str(index-10) + "T15:30:00.000Z"

    if(index < 10):
        to_date = "2023-12-0" + str(index) + "T15:30:00.000Z"
    else:
        to_date = "2023-12-" + str(index) + "T15:30:00.000Z"
    ...
    for stock in stock_list:
        ...
        if 'Success' in entries:
            ...
            if df['ema'].iloc[-1] > df['open'].iloc[-1] and df['ema'].iloc[-1] < df['close'].iloc[-1]:
                ...
                #print(next_day)
                next_date = "2023-12-" + next_day + "T16:00:00.000Z"
                ...
                # Construct the file name
                file_name = f'profit/profit_2023_12_{index}.csv'
                print(file_name)
